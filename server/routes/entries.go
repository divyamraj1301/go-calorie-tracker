...
func AddEntry(c *gin.Context) {
	...
	if insertErr != nil {
		msg := fmt.Println("order item was not created")
...
func UpdateIngredient(c *gin.Context) {
	...
	res, err := entryCollection.UpdateOne(ctx, bson.M{"_id": docID},
...
func DeleteEntry(c *gin.Context) {
	...
	var ctx, cancel = context.WithTimeout(context.Background(), 5000) // TODO: Set timeout based on config
